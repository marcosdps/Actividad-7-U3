...
class ListaPersonal:
    ...
    def menuDirector(self):
        ...
        -4- Modificar procentaje extra a Docente Investigador
        -0- SALIR"""
        ...
        while opcionDirec != 0:
            match opcionDirec:
                case 1:
                    ...
                    self.ManejarDirector.modificarBasico(DNI, nuevoBasico)
                case 2:
                    DNI = input("DNI: ")
                case 3:
                    DNI = input("DNI: ")
    ...
    def director(ManejarDirector:Idirector, self):
        self.menu()
    
    def tesorero(ManejarTesorero: Itesorero, self):
        self.gastosSueldoPorEmpleado()

    #Metodos de Interface Director
    def modificarBasico(self, dni, nuevoBasico):
        print("Aca solo puede acceder el director")
    ...
    def gastosSueldoPorEmpleado(self,ManejarTesorero:Itesorero, dni):
        print("Aca solo puede acceder el tesorero")
